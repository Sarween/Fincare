...
import 'challenge_set_model.dart';
export 'challenge_set_model.dart';

class ChallengeSetWidget extends StatefulWidget {
  const ChallengeSetWidget({Key? key}) : super(key: key);

  @override
  _ChallengeSetWidgetState createState() => _ChallengeSetWidgetState();
}

class _ChallengeSetWidgetState extends State<ChallengeSetWidget>
    with TickerProviderStateMixin {
  late ChallengeSetModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChallengeSetModel());
