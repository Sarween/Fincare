...
import 'transfer_verification_model.dart';
export 'transfer_verification_model.dart';

class TransferVerificationWidget extends StatefulWidget {
  const TransferVerificationWidget({Key? key}) : super(key: key);

  @override
  _TransferVerificationWidgetState createState() =>
      _TransferVerificationWidgetState();
}

class _TransferVerificationWidgetState
    extends State<TransferVerificationWidget> {
  late TransferVerificationModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TransferVerificationModel());
  }
